package at.scch.mbteclo;

import at.scch.mbteclo.adapter.Adapter;
import at.scch.mbteclo.state.ConfigurationSelector;
import at.scch.mbteclo.traversal.FeatureToggleAlgorithm;
import at.scch.mbteclo.traversal.ManualTraversalGui;
import at.scch.teclo.configuration.Configurator;
import at.scch.mbteclo.factories.BugzillaModelFactory;
import at.scch.mbteclo.listener.DOTListener;
import at.scch.mbteclo.listener.ListenerWithState;
...
//		FeatureToggleAlgorithm algo = new FeatureToggleAlgorithm(new WeightedBalancingAlgorithm(), tester);
//		tester.setAlgorithm(algo); tester.addListener(algo);
...
//		tester.setAlgorithm(new ManualTraversalGui());
		...
		ConfigurationSelector.selectConfigurations(tester);
