...
//	}
	...
	public BugzillaState() {
		...
		this.products.add(DEFAULT_PRODUCT);
...
//	}
	...
	public Product getNewRandomProduct(){
		...
		int i = 1;
		while(this.products.contains(randProduct)){
	...
	public Product getRandomProduct(){
		Random rand = new Random();
		return this.products.get(rand.nextInt(this.products.size()));
	}
	...
	public Product getRandomProduct(Collection<Product> excluding) {
		Random rand = new Random();
		List<Product> products = new LinkedList<>(this.products);
